<template>
  <div class="term-block">
    <div class="term-prompt-line">
      <span class="p-user">user@portfolio</span><span class="p-sep">:</span><span class="p-path">~/portfolio</span><span class="p-dollar"> $ </span><span class="p-cmd">whoami</span>
    </div>
    <div class="term-output whoami-output">
      ...
      <div class="wo-line"><span class="wo-key">role</span><span class="wo-colon">:</span>           <span class="wo-val">Technical Lead · Software Architecture</span></div>
